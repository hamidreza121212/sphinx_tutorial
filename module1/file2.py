"""This is the doc string for the file2 file where we can say things about the python module.add()
...
def file2_func2(param1: int, param2: int):
...
def file2_func4(param1: str, param2: int, param3: bool):
...
def file2_func5(param1: str, param2: int):
